...
myigloo_raw_tbl <- read_csv("data/myigloo.csv")

myigloo_tbl <- myigloo_raw_tbl |> 
...
husnaedi_ls$myigloo_index <- myigloo_tbl
husnaedi_ls$myigloo_raw <- myigloo_raw_tbl
...
fjarmal_ls$gengi <- read_csv("data/gengisvisitala.csv")
